...
const ALL_MODULES = [
    ...
    // ... (Use the full list or fetch from backend fallback) ... 
    // For brevity in this initial implementation, we will rely on the fetch logic 
    // effectively used in AssessmentManagement, but simpler here.
];
