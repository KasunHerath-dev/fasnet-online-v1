    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50 p-4 md:p-8">
            <div className="max-w-6xl mx-auto space-y-8 animate-fadeIn">
                ...
                {/* Hero Header */}
                <div className="relative overflow-hidden bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 mb-3">
                            ...
                            <div>
                                <h1 className="text-4xl font-black text-white">Update Student Data</h1>
                                <p className="text-purple-200 text-lg font-medium">Bulk update existing student information from Excel or CSV files</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border-2 border-blue-200">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-blue-900 mb-2">How Updates Work</h3>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-gray-100">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${file ? 'bg-green-500 text-white' : 'bg-purple-600 text-white'}`}>
                                {file ? <CheckCircle className="w-5 h-5" /> : '1'}
                            </div>
                            <div>
                                <p className="font-bold text-gray-900">Upload File</p>
                                <p className="text-sm text-gray-600">Select your update file</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${result ? 'bg-green-500 text-white' : file ? 'bg-purple-600 text-white' : 'bg-gray-300 text-gray-600'}`}>
                                {result ? <CheckCircle className="w-5 h-5" /> : '2'}
                            </div>
                            <div>
                                <p className="font-bold text-gray-900">Update</p>
                                <p className="text-sm text-gray-600">Apply changes</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-gray-100">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-2xl font-black text-gray-900">Upload Update File</h2>
                    </div>
                    ...
                    >
                        ...
                        {!file ? (
                            <label htmlFor="fileInput" className="cursor-pointer block">
                                ...
                                <div className="mt-6 inline-block px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl transition-all shadow-lg">
                                    Choose File
                                </div>
                            </label>
                        ) : (
                    ...
                    {loading && (
                        <div className="mt-6 flex items-center justify-center gap-3 bg-purple-50 p-4 rounded-xl">
                            <div className="w-6 h-6 border-4 border-purple-600 border-t-transparent rounded-full animate-spin"></div>
                            <span className="text-purple-900 font-semibold">Loading preview...</span>
                        </div>
                    )}
                </div>
                    ...
                    <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-gray-100">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                            ...
                            <button
                                ...
                                disabled={importing}
                                className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                            >
                                {importing ? (
                                    <>
                ...
                {result && (
                    <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-purple-200">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-black text-gray-900">Update Complete!</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-purple-100 font-medium mb-1">Students Updated</p>
                                        <p className="text-5xl font-black">{result.updated || 0}</p>
                                    </div>
                            ...
                            <div className="bg-gradient-to-br from-gray-500 to-slate-600 rounded-2xl p-6 text-white shadow-lg">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-gray-100 font-medium mb-1">Skipped (Not Found)</p>
                                        <p className="text-5xl font-black">{result.skipped || 0}</p>
                                    </div>
