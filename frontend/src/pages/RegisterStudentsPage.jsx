    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 p-4 md:p-6 lg:p-8">
            <div className="max-w-6xl mx-auto space-y-4 md:space-y-6 lg:space-y-8 animate-fadeIn">
                ...
                {/* Hero Header */}
                <div className="relative overflow-hidden bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-3 md:gap-4 mb-2 md:mb-3">
                            <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg">
                                <Users className="w-6 h-6 md:w-7 md:h-7 text-white" />
                            </div>
                            <div>
                                <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-white">Register Students</h1>
                                <p className="text-sm md:text-base lg:text-lg text-blue-200 font-medium">Bulk import new students from Excel or CSV files</p>
                            </div>
                        </div>
                    </div>
                </div>
