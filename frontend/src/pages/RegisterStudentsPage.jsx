    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 font-display text-slate-900 dark:text-white pb-20 transition-colors duration-300">
            <div className="relative flex flex-col w-full min-h-screen">
                ...
                <div className="relative w-full h-[200px] md:h-[260px] lg:h-[300px] bg-black overflow-hidden rounded-b-[2rem] md:rounded-b-[3rem] shadow-2xl shadow-slate-900/50 z-10 border-b border-slate-800">
                    ...
                    <div className="relative flex flex-col justify-end h-full px-4 md:px-8 pb-8 md:pb-12 pt-6 md:pt-8 z-10 max-w-7xl mx-auto w-full">
                        <div className="flex items-end gap-3 md:gap-5">
                            ...
                            <div className="relative group">
                                <div className="relative w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-white/5 backdrop-blur-xl flex items-center justify-center border border-white/10 shadow-2xl group-hover:bg-white/10 transition-all duration-300">
